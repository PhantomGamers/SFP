...
public static class PatchConfig
{
    public static IEnumerable<PatchEntry> DefaultPatches { get; } = new[]
    {
        ...
        new PatchEntry { MatchRegex = "^Screenshot Manager$", TargetFile = "libraryroot.custom"},
        new PatchEntry { MatchRegex = "^Achievements$", TargetFile = "libraryroot.custom"},
        new PatchEntry { MatchRegex = "^Add Non-Steam Game$", TargetFile = "libraryroot.custom"},
        new PatchEntry { MatchRegex = "^Game Servers$", TargetFile = "libraryroot.custom"},
        new PatchEntry { MatchRegex = "^Players$", TargetFile = "libraryroot.custom"},
