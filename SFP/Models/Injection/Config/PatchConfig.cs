...
public class PatchConfig
{
    ...
    public static IEnumerable<PatchEntry> DefaultPatches { get; } = new[]
    {
        ...
        new PatchEntry { MatchRegexString = "^OverlayBrowser_Browser$", TargetFile = "libraryroot.custom" },
        new PatchEntry { MatchRegexString = "^SP Overlay:", TargetFile = "libraryroot.custom" },
