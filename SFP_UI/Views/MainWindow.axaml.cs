        ...
        private void TryEnableMicaEffect()
        {
            ...
            if (ActualThemeVariant == ThemeVariant.Dark)
            {
                Color2 color = this.TryFindResource("SolidBackgroundFillColorBase",
                    ThemeVariant.Dark, out object? value) ? (Color2)(Color)value : new Color2(32, 32, 32);
            ...
            else if (ActualThemeVariant == ThemeVariant.Light)
            {
                // Similar effect here
                Color2 color = this.TryFindResource("SolidBackgroundFillColorBase",
                    ThemeVariant.Light, out object? value) ? (Color2)(Color)value : new Color2(243, 243, 243);
