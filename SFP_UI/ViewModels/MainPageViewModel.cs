...
public partial class MainPageViewModel : ViewModelBase
{
    ...
    [Reactive]
    public partial string StartSteamText { get; set; } = Steam.IsSteamRunning ? "Restart Steam" : "Start Steam";
    ...
    [ReactiveCommand]
    private static void UpdateNotificationView(string url)
    {
        Utils.OpenUrl(url);
    }
    ...
    [ReactiveCommand]
    private static void StopInject()
    {
    ...
    private static void TrimOutput()
    {
        ...
        int firstNewlineIndex = output.IndexOf('\n');
        if (firstNewlineIndex == -1)
        {
            return;
        }

        string firstLine = output[..firstNewlineIndex];
        int lastNewlineIndex = output.IndexOf('\n', maxLength / 2);
